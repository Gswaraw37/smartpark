    ...
    <div class="container">
      <div class="heading_container">
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center">
                                @empty($user->foto)
                                    <img src="{{ asset('storage/nophoto.jpg') }}" alt="Admin" class="rounded-circle p-1 bg-primary" width="110">
                                @else
                ...
                <div class="col-lg-8">
                    <div class="card">
                        <form action="{{ route('visitor.profile.editProfile', $user->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                <div class="row mb-3">
