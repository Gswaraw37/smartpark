        ...
        <div class="row">
            <div class="col-md-5">
                ...
                <div class="project-info-box">
                    ...
                    <p><b>Bergabung Sejak:</b></p> 
                    {{ \Carbon\Carbon::parse($staff->created_at)->isoFormat('D MMMM Y') }}
                     ( {{ \Carbon\Carbon::parse($staff->created_at)->diffForHumans() }} ) 
                </div><!-- / project-info-box -->
            </div><!-- / column -->

            <div class="col-md-7">
                @empty($staff->foto)
                    <img src="{{ asset('storage/nophoto.jpg') }}" alt="project-image" class="rounded">
                @else
                    <img src="{{ asset('storage/' . $staff->foto) }}" alt="project-image" class="rounded">
                @endempty
                <div class="project-info-box">
                    <p><b>Nama Lengkap:</b> {{ $staff->full_name }}</p>
                    <p><b>Role:</b> {{ $staff->role }}</p>
                </div><!-- / project-info-box -->
            </div><!-- / column -->
            @if (Auth::user()->role == 'admin')
                <div class="col-md-12">
                    <div class="project-info-box mt-0 mb-0 row justify-content-center">
                        <p class="mb-0">
                            <a href="/admin/daftar-staff/edit/{{ $staff->id }}" class="btn btn-sm btn-primary">Edit</a>
                        </p>
                    </div><!-- / project-info-box -->
                </div>
            @endif
